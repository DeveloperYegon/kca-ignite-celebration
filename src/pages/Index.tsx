...
import { Calendar, MapPin, Hash, Users, Sparkles, Play, ChevronLeft, ChevronRight, ExternalLink } from 'lucide-react';
...
const scheduleData = {
  'day1': {
    ...
    events: [
      { time: '9:00 AM', theme: 'Opening Ceremony & Welcome', speaker: 'Dr. Sarah Tech' },
      { time: '10:30 AM', theme: 'Future of Innovation in Education', speaker: 'Prof. Alice Data' },
      { time: '12:00 PM', theme: 'Lunch & Networking', speaker: '' },
      { time: '2:00 PM', theme: 'Startup Ecosystem & Entrepreneurship', speaker: 'Mark Johnson' },
      { time: '3:30 PM', theme: 'Interactive Workshops', speaker: 'All Speakers' },
      { time: '5:00 PM', theme: 'Day 1 Closing & Networking', speaker: '' }
    ]
  },
  'day2': {
    date: 'October 16, 2024',
    events: [
      { time: '9:00 AM', theme: 'Digital Transformation Keynote', speaker: 'Dr. Sarah Tech' },
      { time: '10:30 AM', theme: 'Product Innovation Workshop', speaker: 'James Innovation' },
      { time: '12:00 PM', theme: 'Lunch & Innovation Expo', speaker: '' },
      { time: '2:00 PM', theme: 'Data Science in Action', speaker: 'Prof. Alice Data' },
      { time: '3:30 PM', theme: 'Panel Discussion: Future Tech', speaker: 'All Speakers' },
      { time: '5:00 PM', theme: 'Innovation Showcase', speaker: '' }
    ]
  },
  'day3': {
    date: 'October 17, 2024',
    events: [
      { time: '9:00 AM', theme: 'AI & Machine Learning Summit', speaker: 'Prof. Alice Data' },
      { time: '10:30 AM', theme: 'Building Sustainable Startups', speaker: 'Mark Johnson' },
      { time: '12:00 PM', theme: 'Awards Lunch', speaker: '' },
      { time: '2:00 PM', theme: 'Innovation Competition Finals', speaker: 'James Innovation' },
      { time: '4:00 PM', theme: 'Closing Ceremony & Awards', speaker: 'Dr. Sarah Tech' },
      { time: '5:30 PM', theme: 'Farewell Reception', speaker: '' }
    ]
  }
};

const partners = [
  'Microsoft', 'Google', 'IBM', 'Amazon Web Services', 'Intel', 'NVIDIA', 'Safaricom', 'KCB Bank', 'Equity Bank', 'Nation Media Group'
];
...
const Index = () => {
  ...
  const handleSpeakerHover = (speakerName: string, event: React.MouseEvent) => {
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Join us for an inspiring opening address that will set the tone for three days of innovation and discovery.
            </p>
          </div>
              ...
              <CardContent className="p-8">
                <div className="flex flex-col lg:flex-row items-center gap-8">
                  ...
                  <div className="flex-1 text-center lg:text-left">
                    ...
                    <div className="mb-6">
                      <Badge variant="secondary" className="mr-2 mb-2">Digital Transformation</Badge>
                      <Badge variant="secondary" className="mr-2 mb-2">AI & Ethics</Badge>
                      <Badge variant="secondary" className="mr-2 mb-2">Innovation Strategy</Badge>
                    </div>
                    <Button 
                      className="btn-hero"
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Explore our comprehensive schedule filled with keynotes, workshops, and networking opportunities.
            </p>
          </div>

          <Tabs defaultValue="day1" className="max-w-6xl mx-auto">
            <TabsList className="grid w-full grid-cols-3 mb-8">
              <TabsTrigger value="day1" className="text-lg py-3">Day 1 - Oct 15</TabsTrigger>
              <TabsTrigger value="day2" className="text-lg py-3">Day 2 - Oct 16</TabsTrigger>
              <TabsTrigger value="day3" className="text-lg py-3">Day 3 - Oct 17</TabsTrigger>
            </TabsList>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold gradient-text mb-6">Industry Leaders & Innovators</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Learn from distinguished speakers who are shaping the future of technology and innovation.
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We're proud to partner with leading organizations driving innovation across various industries.
            </p>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Relive the excitement from our previous innovation weeks and see what makes our events special.
            </p>
          </div>

          <Tabs defaultValue="photos" className="max-w-4xl mx-auto">
            <TabsList className="grid w-full grid-cols-2 mb-8">
              <TabsTrigger value="photos" className="text-lg py-3">Photo Gallery</TabsTrigger>
              <TabsTrigger value="social" className="text-lg py-3">Social Media</TabsTrigger>
            </TabsList>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-glow text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join us for three unforgettable days of learning, networking, and innovation at KCA University.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
